...
export const guestyApi = api.injectEndpoints({
  endpoints: (builder) => ({
    getGuestyProperties: builder.query({
      queryFn: async () => {
        try {
          const token = 'eyJraWQiOiJHdlpFNmFDOGVETHJQTy1kOE9ZRV9SWFB5V1NpN0tKeWI3VjBycEhrTTdRIiwiYWxnIjoiUlMyNTYifQ..TzOcqLZKTRA5VcOq9CsmysBVXM5TvCNKae5mEVbWFRKv3WTqdDyfKUYHiefWzIZD4x3GolosWm6MVKsRsx7jZQAo1beuaFfNfUHhZe05-W56L1UpmdWQjiUcKNIFBwJmvG4mUrkpabTrMPW3kDZuzCxd70Mll-L2DDdn7xapXYkjaEERDIvhPQqeFOuVr3NuPsOZvUJjR4YA6ksjyBCJDbT6zy4jWDlgSOZIVwGdSPetTRmxLB94zvObUSp7gNVvIIH89CcsvuNs-8GMvpJkgoquaYIMTWHBzUMcsXcjCm0qtdaXIEMv43ETOnjnp_GQS4S61Q0zkSkfigJNLfWi0Q'; // Get the valid token dynamically
