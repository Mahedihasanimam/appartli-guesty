          ...
          <div className="w-full flex gap-6 items-center justify-center">
            ...
            <div>
              ...
              >
              {
                user ? <div>
                   {
                user?.data?.image ? <Avatar size={50} className="bg-gray-400">
                  <Image width={50}
                    height={50} src={imageUrl + user?.data?.image} alt="Avatar" />
